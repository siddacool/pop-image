<template>
  <Button
    class="photo-loader-button"
    :disabled="isImageFetching"
    @click="handleImageRefresh"
  >
    <svg
...
import { isImageFetching } from '../store/getters';
import Button from './Button.vue';

export default defineComponent({
  name: 'PhotoLoaderButton',
  components: {
    Button,
  },
  setup() {
    ...
    const handleImageRefresh = (e: { preventDefault: () => void }) => {
      e.preventDefault();
